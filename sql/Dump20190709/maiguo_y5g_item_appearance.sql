...
CREATE TABLE `y5g_item_appearance` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='外观表';
...
INSERT INTO `y5g_item_appearance` VALUES (1,1,1,'红色',1,1562384881,1562384881),(2,1,2,'魅海蓝',1,1562487739,1562487739);
