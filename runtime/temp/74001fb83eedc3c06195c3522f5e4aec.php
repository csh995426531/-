<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/wwwroot/maig/public/../application/index/view/setting/feature.html";i:1562975332;s:52:"/www/wwwroot/maig/application/index/view/layout.html";i:1567309984;}*/ ?>
<!DOCTYPE html>
            ...
            <table class="orders-table table">
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <a class="btn btn-small btn-danger del-item" data-id="<?php echo $temp['id']; ?>" data-href="<?php echo url('delFeature'); ?>">停用</a>
                        <?php else: ?>
