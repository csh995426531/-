<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/data/www/y5g/public/../application/index/view/setting/name.html";i:1592990572;s:48:"/data/www/y5g/application/index/view/layout.html";i:1592482662;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <script>
        layui.use(['index', 'contlist', 'table', 'jquery'], function () {
            ...
            table.render({
                elem: '#table-list'
                , url: '/index/setting/nameList' //数据接口
                ...
                , cols: [[ //表头
                    ...
                    , {
                        field: 'data', title: '名称值', minWidth: 80
                    }
                    , {
                        fixed: 'right', title: '操作', minWidth: 100, templet: function (d) {
                            if (d.status == 1) {
                                var str = '<a class="layui-btn-sm layui-btn layui-btn-danger" onclick="stopItem(this,' + d.id + ')" data-href="/index/setting/delName?id=' + d.id + '" >停用</a>';
                            } else {
                                var str = '<a class="layui-btn-sm layui-btn" onclick="openItem(this,' + d.id + ')" data-href="/index/setting/openName?id=' + d.id + '" >启用</a>';
                            }
                            return str += '<a class="layui-btn-sm layui-btn layui-btn-normal" onclick="edit(this,' + d.id + ')" data-href="/index/popup/name?id=' + d.id + '" >修改</a>';
                        }
                    }
                ]]
            });
