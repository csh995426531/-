<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/data/www/y5g/public/../application/index/view/item/income_agree.html";i:1592471326;s:48:"/data/www/y5g/application/index/view/layout.html";i:1592482662;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="layui-fluid">
      ...
      <script>
        layui.use(['laydate', 'index', 'contlist', 'table', 'jquery'], function(){
            ...
            table.render({
                elem: '#table-list'
                ,url: '/index/item/incomeAgreeList' //数据接口
                ,title: '入库审核'
                ...
                ,cols: [[ //表头
                    ...
                    ,{fixed: 'right', title: '操作', minWidth: 140, sort: true,templet: function(d){
                        var str = '<a class="layui-btn layui-btn-sm" onclick="allowAgree(this,' + d.id + ')" data-value="1" data-href="/index/item/allowAgree?id=' + d.id + '">通过</a>';
                        return str + '<a class="layui-btn layui-btn-warm layui-btn-sm" onclick="rejectAgree(this,' + d.id + ')" data-value="0" data-href="/index/item/rejectAgree?id=' + d.id + '">拒绝</a>';
                    }}
                ]]
            });
            ...
            table.on('toolbar(table-list)', function(obj){
                ...
                switch(obj.event){
                    ...
                    break;
                    case 'batchReject':
                        var url = '/index/item/rejectAgree';
                        if (arr.length > 0) {
                            $.post(url, {id:arr}, function(res) {
                                layer.msg(res.data, {
                                    icon: 1,
