<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/wwwroot/maig/public/../application/index/view/setting/network.html";i:1562327614;s:52:"/www/wwwroot/maig/application/index/view/layout.html";i:1562327611;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="row">
            ...
            <table class="orders-table table">
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <a class="btn btn-small btn-danger del-item" data-id="<?php echo $temp['id']; ?>" data-href="<?php echo url('delNetwork'); ?>">停用</a>
                        <?php else: ?>
                        <a class="btn btn-small btn-success del-item" data-id="<?php echo $temp['id']; ?>" data-href="<?php echo url('openNetwork'); ?>">启用</a>
                        <?php endif; ?>
                    </td>
                </tr>
    ...
    <div class="modal hide fade" id="addItem">
        ...
        <form class="form-horizontal" method="post" id="form" data-action="<?php echo url('addNetwork'); ?>">
            <fieldset>
    ...
    $(function(){
        $("#submit").click(function(){
            ...
            $.post(url, data, function (res) {
                alert(res.data);
                window.location.replace("<?php echo url('network');?>");
            })
        });
