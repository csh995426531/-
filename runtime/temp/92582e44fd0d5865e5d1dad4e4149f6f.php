<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/maig/public/../application/index/view/setting/income_channel.html";i:1559823030;s:52:"/www/wwwroot/maig/application/index/view/layout.html";i:1559823025;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <table class="orders-table table">
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <!--<a class="btn btn-small btn-primary" href="form.html">Edit</a>-->
                        <a class="btn btn-small btn-danger del-item" data-id="<?php echo $temp['id']; ?>" data-href="<?php echo url('delChannel'); ?>">删除</a>
                    </td>
                </tr>
