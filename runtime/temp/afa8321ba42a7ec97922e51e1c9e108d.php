<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/data/www/y5g/public/../application/index/view/setting/type.html";i:1587556987;s:48:"/data/www/y5g/application/index/view/layout.html";i:1587551009;}*/ ?>
<!DOCTYPE html>
...
<div class="row">
        ...
        <div class="span12">
            ...
            <table class="orders-table table">
                ...
                <tr>
                    ...
                    <td><span><?php echo $temp['itemNetwork']['data']; ?></span></td>
                    ...
                    <td class="actions">
                        ...
                        <a class="btn btn-small btn-danger del-item" data-id="<?php echo $temp['id']; ?>" data-href="<?php echo url('delType'); ?>">停用</a>
                        <?php else: ?>
                        <a class="btn btn-small btn-success del-item" data-id="<?php echo $temp['id']; ?>" data-href="<?php echo url('openType'); ?>">启用</a>
                        <?php endif; ?>
                        <button class="btn btn-info edit"  data-toggle="modal" href="#addItem" data-id="<?php echo $temp['id']; ?>" data-name_id="<?php echo $temp['name_id']; ?>" data-network_id="<?php echo $temp['network_id']; ?>" data-network="<?php echo $temp['itemNetwork']['data']; ?>" data-data="<?php echo $temp['data']; ?>">修改</button>
                    </td>
                </tr>
    ...
    <div class="modal hide fade" id="addItem">
        ...
        <form class="form-horizontal" method="post" id="form" data-action="<?php echo url('addType'); ?>">
            <fieldset>
                    ...
                    <div class="controls">
                        <select id="name_id" class="input-xlarge" name="name_id">
                            ...
                            <optgroup label="<?php echo $category['category']['data']; ?>">
                                ...
                                <option value="<?php echo $name['id']; ?>" data-network="
