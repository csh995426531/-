<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/maig/public/../application/index/view/members/update_pwd.html";i:1559796725;s:52:"/www/wwwroot/maig/application/index/view/layout.html";i:1559796721;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <form class="form-horizontal" method="post">
                <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="user_id">选择账号</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="pwd_1">新密码</label>
                        <div class="controls">
                            <input type="text" class="input-xlarge" id="pwd_1" name="pwd_1" value="">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="pwd_2">确认新密码</label>
                        <div class="controls">
