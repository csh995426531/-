<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"/data/www/y5g/public/../application/index/view/setting/edition.html";i:1571557163;s:48:"/data/www/y5g/application/index/view/layout.html";i:1571074441;}*/ ?>
<!DOCTYPE html>
    ...
    $(function(){
        $("#submit").click(function(){
            ...
            $.post(url, data, function (res) {
                alert(res.data);
                window.location.replace("<?php echo url('edition');?>");
            })
        });
