<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/maig/public/../application/index/view/item/return_income.html";i:1562327612;s:52:"/www/wwwroot/maig/application/index/view/layout.html";i:1562327611;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <table class="orders-table table">
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <a class="btn btn-small btn-success add-return-income" data-href="<?php echo url('addReturnIncome'); ?>" data-id="<?php echo $temp['id']; ?>">退货入库</a>
...
<script>
    $(function(){
        $(".add-return-income").click(function(){
            var url = $(this).data('href');
            var id = $(this).data('id');
            $.post(url, {id:id}, function (res) {
                alert(res.data);
                window.location.replace("<?php echo url('returnIncome');?>");
            })
        });
